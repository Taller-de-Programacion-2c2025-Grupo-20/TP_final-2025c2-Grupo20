...
const std::map<int, SDL2pp::Rect> SpritesManager::carPositionsGreen = {
        {0, SDL2pp::Rect(0, 0, 32, 32)},     {1, SDL2pp::Rect(32, 0, 32, 32)},
        {2, SDL2pp::Rect(64, 0, 32, 32)},    {3, SDL2pp::Rect(96, 0, 32, 32)},
        {4, SDL2pp::Rect(128, 0, 32, 32)},   {5, SDL2pp::Rect(160, 0, 32, 32)},
        {6, SDL2pp::Rect(192, 0, 32, 32)},   {7, SDL2pp::Rect(224, 0, 32, 32)},
        {8, SDL2pp::Rect(0, 32, 32, 32)},    {9, SDL2pp::Rect(32, 32, 32, 32)},
        {10, SDL2pp::Rect(64, 32, 32, 32)},  {11, SDL2pp::Rect(96, 32, 32, 32)},
        {12, SDL2pp::Rect(128, 32, 32, 32)}, {13, SDL2pp::Rect(160, 32, 32, 32)},
        {14, SDL2pp::Rect(192, 32, 32, 32)}, {15, SDL2pp::Rect(224, 32, 32, 32)}};
const std::map<int, SDL2pp::Rect> SpritesManager::carPositionsRed = {
        {0, SDL2pp::Rect(0, 64, 40, 40)},     {1, SDL2pp::Rect(40, 64, 40, 40)},
        {2, SDL2pp::Rect(80, 64, 40, 40)},    {3, SDL2pp::Rect(120, 64, 40, 40)},
        {4, SDL2pp::Rect(160, 64, 40, 40)},   {5, SDL2pp::Rect(200, 64, 40, 40)},
        {6, SDL2pp::Rect(240, 64, 40, 40)},   {7, SDL2pp::Rect(280, 64, 40, 40)},
        {8, SDL2pp::Rect(0, 104, 40, 40)},    {9, SDL2pp::Rect(40, 104, 40, 40)},
        {10, SDL2pp::Rect(80, 104, 40, 40)},  {11, SDL2pp::Rect(120, 104, 40, 40)},
        {12, SDL2pp::Rect(160, 104, 40, 40)}, {13, SDL2pp::Rect(200, 104, 40, 40)},
        {14, SDL2pp::Rect(240, 104, 40, 40)}, {15, SDL2pp::Rect(280, 104, 40, 40)}};
const std::map<int, SDL2pp::Rect> SpritesManager::carPositionsDescapotable = {
        {0, SDL2pp::Rect(0, 144, 40, 40)},    {1, SDL2pp::Rect(40, 144, 40, 40)},
        {2, SDL2pp::Rect(80, 144, 40, 40)},   {3, SDL2pp::Rect(120, 144, 40, 40)},
        {4, SDL2pp::Rect(160, 144, 40, 40)},  {5, SDL2pp::Rect(200, 144, 40, 40)},
        {6, SDL2pp::Rect(240, 144, 40, 40)},  {7, SDL2pp::Rect(280, 144, 40, 40)},
        {8, SDL2pp::Rect(0, 184, 40, 40)},    {9, SDL2pp::Rect(40, 184, 40, 40)},
        {10, SDL2pp::Rect(80, 184, 40, 40)},  {11, SDL2pp::Rect(120, 184, 40, 40)},
        {12, SDL2pp::Rect(160, 184, 40, 40)}, {13, SDL2pp::Rect(200, 184, 40, 40)},
        {14, SDL2pp::Rect(240, 184, 40, 40)}, {15, SDL2pp::Rect(280, 184, 40, 40)}};
const std::map<int, SDL2pp::Rect> SpritesManager::carPositionsCeleste = {
        {0, SDL2pp::Rect(0, 224, 40, 40)},    {1, SDL2pp::Rect(40, 224, 40, 40)},
        {2, SDL2pp::Rect(80, 224, 40, 40)},   {3, SDL2pp::Rect(120, 224, 40, 40)},
        {4, SDL2pp::Rect(160, 224, 40, 40)},  {5, SDL2pp::Rect(200, 224, 40, 40)},
        {6, SDL2pp::Rect(240, 224, 40, 40)},  {7, SDL2pp::Rect(280, 224, 40, 40)},
        {8, SDL2pp::Rect(0, 264, 40, 40)},    {9, SDL2pp::Rect(40, 264, 40, 40)},
        {10, SDL2pp::Rect(80, 264, 40, 40)},  {11, SDL2pp::Rect(120, 264, 40, 40)},
        {12, SDL2pp::Rect(160, 264, 40, 40)}, {13, SDL2pp::Rect(200, 264, 40, 40)},
        {14, SDL2pp::Rect(240, 264, 40, 40)}, {15, SDL2pp::Rect(280, 264, 40, 40)}};
const std::map<int, SDL2pp::Rect> SpritesManager::carPositionsJeep = {
        {0, SDL2pp::Rect(0, 304, 40, 40)},    {1, SDL2pp::Rect(40, 304, 40, 40)},
        {2, SDL2pp::Rect(80, 304, 40, 40)},   {3, SDL2pp::Rect(120, 304, 40, 40)},
        {4, SDL2pp::Rect(160, 304, 40, 40)},  {5, SDL2pp::Rect(200, 304, 40, 40)},
        {6, SDL2pp::Rect(240, 304, 40, 40)},  {7, SDL2pp::Rect(280, 304, 40, 40)},
        {8, SDL2pp::Rect(0, 344, 40, 40)},    {9, SDL2pp::Rect(40, 344, 40, 40)},
        {10, SDL2pp::Rect(80, 344, 40, 40)},  {11, SDL2pp::Rect(120, 344, 40, 40)},
        {12, SDL2pp::Rect(160, 344, 40, 40)}, {13, SDL2pp::Rect(200, 344, 40, 40)},
        {14, SDL2pp::Rect(240, 344, 40, 40)}, {15, SDL2pp::Rect(280, 344, 40, 40)}};
const std::map<int, SDL2pp::Rect> SpritesManager::carPositionsCamioneta = {
        {0, SDL2pp::Rect(0, 384, 40, 40)},    {1, SDL2pp::Rect(40, 384, 40, 40)},
        {2, SDL2pp::Rect(80, 384, 40, 40)},   {3, SDL2pp::Rect(120, 384, 40, 40)},
        {4, SDL2pp::Rect(160, 384, 40, 40)},  {5, SDL2pp::Rect(200, 384, 40, 40)},
        {6, SDL2pp::Rect(240, 384, 40, 40)},  {7, SDL2pp::Rect(280, 384, 40, 40)},
        {8, SDL2pp::Rect(0, 424, 40, 40)},    {9, SDL2pp::Rect(40, 424, 40, 40)},
        {10, SDL2pp::Rect(80, 424, 40, 40)},  {11, SDL2pp::Rect(120, 424, 40, 40)},
        {12, SDL2pp::Rect(160, 424, 40, 40)}, {13, SDL2pp::Rect(200, 424, 40, 40)},
        {14, SDL2pp::Rect(240, 424, 40, 40)}, {15, SDL2pp::Rect(280, 424, 40, 40)}};
const std::map<int, SDL2pp::Rect> SpritesManager::carPositionsCamion = {
        {0, SDL2pp::Rect(0, 464, 48, 48)},    {1, SDL2pp::Rect(48, 464, 48, 48)},
        {2, SDL2pp::Rect(96, 464, 48, 48)},   {3, SDL2pp::Rect(144, 464, 48, 48)},
        {4, SDL2pp::Rect(192, 464, 48, 48)},  {5, SDL2pp::Rect(240, 464, 48, 48)},
        {6, SDL2pp::Rect(288, 464, 48, 48)},  {7, SDL2pp::Rect(336, 464, 48, 48)},
        {8, SDL2pp::Rect(0, 512, 48, 48)},    {9, SDL2pp::Rect(48, 512, 48, 48)},
        {10, SDL2pp::Rect(96, 512, 48, 48)},  {11, SDL2pp::Rect(144, 512, 48, 48)},
        {12, SDL2pp::Rect(192, 512, 48, 48)}, {13, SDL2pp::Rect(240, 512, 48, 48)},
        {14, SDL2pp::Rect(288, 512, 48, 48)}, {15, SDL2pp::Rect(336, 512, 48, 48)}};
const SDL2pp::Rect SpritesManager::CHECKPOINT_PANEL = SDL2pp::Rect(925, 76, 270, 86);

const SDL2pp::Rect SpritesManager::CHECKPOINT_TENS_SLOT = SDL2pp::Rect(937, 97, 38, 44);

const SDL2pp::Rect SpritesManager::CHECKPOINT_UNITS_SLOT = SDL2pp::Rect(977, 97, 38, 44);
...
// HUD: dígitos 0–9
const SDL2pp::Rect& SpritesManager::getDigitRect(int d) const { return DIGITS[d % 10]; }
...
const SDL2pp::Rect& SpritesManager::getHeartSlotRect(int idx) const { return HEART_SLOTS.at(idx); }
...
const SDL2pp::Rect& SpritesManager::getCheckpointPanelRect() const { return CHECKPOINT_PANEL; }
