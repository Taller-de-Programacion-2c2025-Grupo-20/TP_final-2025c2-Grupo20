...
inline const std::string FONT_FILE = std::string(SDL_DATA_PATH) + "/font/PressStart2P-Regular.ttf";
inline const std::string LOBBY_FILE = std::string(QT_IMAGES_PATH) + "/fondo_lobby.png";
inline const std::string GARAGE_FILE = std::string(QT_IMAGES_PATH) + "/fondo_garage.png";
inline const std::string SELECT_MAP_FILE = std::string(QT_IMAGES_PATH) + "/fondo_select_map.png";
inline const std::string RESULT_FILE = std::string(QT_IMAGES_PATH) + "/fondo_result.png";
