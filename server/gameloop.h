...
struct CarInfo {
    ...
    CarInfo(uint8_t player_id, CarType type, float next_race_time_penalty):
            player_id(player_id), type(type), next_race_time_penalty(next_race_time_penalty) {}
};
...
private:
    ...
    std::chrono::_V2::steady_clock::time_point keepLoopRate(
