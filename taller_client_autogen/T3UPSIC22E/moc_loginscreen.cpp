...
#include <memory>
#include "../../client/Pantallas/loginscreen.h"
...
Q_CONSTINIT static const qt_meta_stringdata_LoginScreen_t qt_meta_stringdata_LoginScreen = {
    {
        ...
        QT_MOC_LITERAL(38, 23)   // "on_btn_conectar_clicked"
    },
    "LoginScreen",
    "connectAttempted",
    "",
...
void LoginScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->connectAttempted((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
...
// SIGNAL 0
void LoginScreen::connectAttempted(const QString & _t1, const QString & _t2)
{
